...
const ARTISTES = [
    { id: 1, name: "Olamide", genre: "Afrobeats", role: "Label Exec / Artiste" },
    { id: 2, name: "Asake", genre: "Street Pop", role: "Global Superstar" },
    { id: 3, name: "Fireboy DML", genre: "Afro-Life", role: "Vocalist" },
    { id: 4, name: "Seyi Vibez", genre: "Street Pop", role: "Hit Maker" },
    { id: 5, name: "Young Jonn", genre: "Afrobeats", role: "Producer / Artiste" },
...
const UPDATES = [
    ...
    { id: 3, title: "Sold out O2 Arena: The Manti Experience", type: "Event Coverage", date: "March 10, 2026", readTime: "3 min read" },
];
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {ARTISTES.map((artiste) => (
                            <div key={artiste.id} className="group relative overflow-hidden rounded-xl aspect-[4/5] bg-mg-surface border border-mg-secondary cursor-pointer">
                                {/* Fallback visual */}
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6 z-20 flex justify-between items-end transform group-hover:-translate-y-2 transition-transform duration-300">
                                    <div>
                                        <span className="text-mg-primary text-xs font-bold tracking-widest uppercase mb-1 block">
                                            {artiste.genre}
                                        </span>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="flex flex-col gap-6">
                        {UPDATES.map((update) => (
                            <div
                                key={update.id}
                                className="group flex flex-col md:flex-row gap-6 md:gap-10 items-start md:items-center p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-mg-secondary hover:border-mg-primary transition-colors cursor-pointer"
                            >
                                ...
                                <div className="self-end md:self-center">
                                    <button className="flex items-center gap-2 px-5 py-3 rounded-full border border-mg-secondary text-white group-hover:bg-mg-primary group-hover:text-black group-hover:border-mg-primary transition-all font-semibold">
                                        Read More
